...
export function chaiTapriRevenue(customers) {
  if (customers !== null && typeof customers == "number" && Number.isInteger(customers) && customers > 0 ) {
    let cuttingChai = 0
    let specialChai = 0
    ...
    let totalChai = cuttingChai + specialChai
    let totalRevenue = (cuttingChai * 10) + (specialChai * 15)
