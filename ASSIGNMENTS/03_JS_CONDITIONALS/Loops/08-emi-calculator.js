...
export function calculateEMI(principal, monthlyRate, emi) {
  if (
    principal !== null && Number.isInteger(principal) && principal > 0 &&
    monthlyRate !== null && monthlyRate > 0&&
    emi !== null && Number.isInteger(emi) && emi > 0
) {
// principal,  monthlyRate,  emi
// 10000,      0.01,         2000
  ...
  return {months: month , totalPaid:Number(totalPaid.toFixed(2)) , totalInterest:Number(totalInterest.toFixed(2))}
